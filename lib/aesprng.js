	...
	this.key = new Array();
	this.key = seed;
	this.itext = aes.hexToByteArray("9F489613248148F9C27945C6AE62EECA3E3367BB14064E4E6DC67A9F28AB3BD1");
	...
	bsb = aes.get_blockSize;
	aes.set_blockSize(256);    
	var i, ct;
    	for (i = 0; i < 3; i++) {
	    this.key = aes.rijndaelEncrypt(this.itext, this.key, "ECB");
	}
